...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      { title: 'Doações', component:JungledoacoesPage },
      { title: 'Doar', component:DoarPage },
      { title: 'Minhas Plantas', component:PlantasPage },
      { title: 'Cadastro de Locais', component:CadastrolocaisPage },
